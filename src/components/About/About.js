      ...
      <div className="Container">
        ...
        <ScrollAnimation animateIn="fadeIn">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeIn">
            Hello! My name is <strong>Yazan Haddad</strong>. I'm originally from Brazil and have been living in Canada for the past three years. During my time here, I gained valuable experience through various entry-level positions, which greatly enhanced my work ethic, communication skills, and adaptability.
            </ScrollAnimation>
